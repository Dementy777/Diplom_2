...
public class RestConfig {
    ...
    public static final String POSTPASSWORDRESET="/api/password-reset";
    public static final String POSTREGISTER="/api/auth/register";
    public static final String POSTLOGIN="/api/auth/login";
    public static final String POSTLOGOUT="/api/auth/logout";
    public static final String POSTTOKEN="/api/auth/token";
